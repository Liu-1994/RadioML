...
def run(args):
    ...
    if args.mode == 'raw':
        ...
        train_data, train_label, val_data, val_label = load_data_from_mat(args.data_path, snr_index)
        ...
        checkpoint_path = os.path.join(args.checkpoint_path,  'constellation_diagram'
...
def parse_arguments(argv):
    ...
    parser.add_argument('--signal_to_noise_ratio', type=int, default=0)
